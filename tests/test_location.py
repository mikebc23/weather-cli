...
from weather.location import LocationResolver, Coordinates, is_zipcode, is_coordinates
...
class TestLocationResolver:
    ...
    def test_detect_location_type(self):
        ...
        # DMS coordinates
        assert resolver._detect_location_type("40°42'46.0\"N 74°00'21.6\"W") == "dms_coordinates"
