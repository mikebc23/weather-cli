...
class AsciiFormatter(WeatherFormatter):
    ...
    def format(self, weather_data: WeatherData) -> str:
        """
        Format weather data with ASCII art.
        ...
        wind_str = f"{self._get_wind_arrow(wind_direction_deg)} {wind_speed} {wind_unit}"
    ...
    def _get_wind_arrow(self, wind_direction_deg) -> str:
        """
